...
function projects() {
  return (
    <>
      <div id='Project' className='w-full h-screen rounded-t-3xl md:px-14 bg-[#EFD593]'>
        <div className='py-14 font-semibold font-poppins text-[8vh] md:text-[12vh] tracking-tight'>
          <h1 className='px-[22vw] md:px-[5vh]'>Projects</h1>
      ...
      <div className='-mt-[4vh]'>
        ...
        <div className='mx-[5vh] md:mx-[1vw] h-[30vh] md:w-full md:h-[60vh] pt-8 md:pt-16 bg-zinc-900  rounded-3xl overflow-hidden object-cover'>
          <img src={Image1}></img>
        </div>
        </div>
      ...
      <h1 className='ml-[3vh]'>E-commerce Website</h1>
        <div className='mx-[5vh] md:mx-[1vw] h-[30vh] md:h-[60vh] pt-6 md:pt-16 rounded-3xl overflow-hidden bg-zinc-900'>
          <img src={Image2}></img>
        </div>
      </div>
      </div>
